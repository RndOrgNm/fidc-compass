...
export type PlotlyCarouselSlide = {
  ...
  filterable?: boolean;
  /** When true hides the built-in fund selector — pair with selectedFund/onFundChange on the card */
...
interface PlotlySlideCardProps {
  slide: PlotlyCarouselSlide;
  selectedFund?: string;
 ...
 */
export function PlotlySlideCard({ slide, selectedFund, onFundChange }: PlotlySlideCardProps) {
  return (
      ...
      <div className="min-w-0 overflow-x-auto">
        {slide.filterable ? (
          <PlotlyFundFilterFigure
            ...
            hideFundSelector={slide.hideFundSelector}
            selectedValue={slide.hideFundSelector ? selectedFund : undefined}
            onSelectedValueChange={slide.hideFundSelector ? onFundChange : undefined}
          />
        ) : (
